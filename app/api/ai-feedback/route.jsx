    ...
    for (const model of MODELS) {
      for (let attempt = 0; attempt < 2; attempt++) {
        try {
          ...
          // and retrying catches that automatically instead of saving broken feedback.
          if (!parsed?.rating || !parsed?.Recommendation) {
            throw Object.assign(new Error("AI response did not contain valid feedback"), { isOutputValidationError: true });
          }
